        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-2xl overflow-hidden">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-white/90 disabled:bg-white/50 rounded-xl text-black text-sm font-medium transition-colors"
            >
              {isLoading === 'google' ? (
            ...
            <button
              ...
              disabled={isLoading !== null}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white/[0.05] hover:bg-white/[0.08] disabled:bg-white/[0.02] border border-white/10 rounded-xl text-white text-sm font-medium transition-colors"
            >
              {isLoading === 'github' ? (
                <Loader2 className="w-4 h-4 animate-spin" />
              ) : (
